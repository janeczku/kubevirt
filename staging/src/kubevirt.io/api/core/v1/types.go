...
type VirtualMachineInstanceSpec struct {
	...
	// TopologySpreadConstraints describes how a group of VMIs ought to spread across topology
	...
	TopologySpreadConstraints []k8sv1.TopologySpreadConstraint `json:"topologySpreadConstraints,omitempty" patchStrategy:"merge" patchMergeKey:"topologyKey" protobuf:"bytes,33,opt,name=topologySpreadConstraints"`
